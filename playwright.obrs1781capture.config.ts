...
/**
 * OBRS-1781 AC-7 — AFTER evidence for the boarding-scan note's new position.
 *
 *   npx playwright test --config=playwright.obrs1781capture.config.ts
 *
