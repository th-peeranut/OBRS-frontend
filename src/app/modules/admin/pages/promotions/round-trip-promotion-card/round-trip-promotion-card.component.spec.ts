...
import { RoundTripPromotionCardComponent } from './round-trip-promotion-card.component';
...
function makeComponent(adminApi: Record<string, unknown>, store = makeStoreStub()) {
  ...
  const component = new RoundTripPromotionCardComponent(
    store as any,
    adminApi as any,
    new FormBuilder(),
    alert as any,
...
describe('RoundTripPromotionCardComponent', () => {
