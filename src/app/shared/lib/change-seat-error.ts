...
const TERMINAL_ERROR_CODES: readonly string[] = [
  ...
  'CHANGE_SEAT_ERROR_MULTI_LEG_NOT_SUPPORTED',
  // OBRS-599: OPEN seating is a permanent property of the trip, not a state
  // that can move under the dialog — re-fetching the seat map would return
  // the same rejection, so this closes like the other terminal codes.
